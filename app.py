...
initial_messages = [
    {
        ...
        "content": (
            ...
            "If the user enters an RS value (e.g., rs1234), validate that it is a real RS ID before responding. "
            "A valid RS ID consists of 'rs' followed by a sequence of digits, e.g., 'rs12345'. "
            "If the RS ID is invalid (e.g., 'rs', 'rs0', or non-numeric sequences like 'rsABC'), respond with an error message: "
            "'Invalid RS ID. Please enter a valid RS number (e.g., rs12345)'. Do not generate or assume an RS value. "
            
            "If both an RS value and a chromosome-position-ref-alt variant are provided, prioritize the full variant. "
            "However, if any information is missing from the chromosome, position, ref base, or alt base, and a valid RS ID is present, "
            "return only the RS ID. Example: "
            "User input: 'rs124234 chromosome:3, pos:13423'. You reply: 'rs124234' since the ref base and alt base are missing."
        ),
    }
]
